...
def get_activities(
    ...
    - difficulty: Filter by difficulty level ('Beginner', 'Intermediate', 'Advanced', or 'all_levels' for activities with no difficulty set)
    """
    ...
    if difficulty == "all_levels":
        ...
        raise HTTPException(status_code=400, detail="Invalid difficulty value. Use 'Beginner', 'Intermediate', 'Advanced', or 'all_levels'.")
